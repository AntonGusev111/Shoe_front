...
const getHitsEpic = (action$) =>
  action$.pipe(
    ...
    switchMap((o) =>
      ajax.getJSON("http://89.111.154.70:7080/api/top-sales").pipe(
        retry(4),
...
const getCategoriesEpic = (action$) =>
  action$.pipe(
    ...
    switchMap((o) =>
      ajax.getJSON("http://89.111.154.70:7080/api/categories").pipe(
...
const getCatalogEpic = (action$) =>
  action$.pipe(
    ...
    switchMap((o) =>
      ajax.getJSON(`http://89.111.154.70:7080/api/items?${o}`).pipe(
        retry(3),
...
const postOrderEpic = (action$) =>
  action$.pipe(
    ...
    switchMap((o) =>
      ajax({
        url: "http://89.111.154.70:7080/api/order",
        method: "POST",
        headers: {
